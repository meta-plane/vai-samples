...
public:
        ...
        : C(channels), eps(epsilon)
    {
        slots.try_emplace("in0", NodeSlot::input, this);
        slots.try_emplace("out0", NodeSlot::output, this);
        slots.try_emplace("gamma", NodeSlot::input, this);
...
Inverted Residual Block (MBConv):
  Input (H▼W▼C_in)
      弛
      戍式式 [Expansion] PwConv 1▼1 (C_in ⊥ C_in▼t) + BN + ReLU6   (skip if t=1)
      弛
      戍式式 [Depthwise] DWConv 3▼3 (C_in▼t ⊥ C_in▼t) + BN + ReLU6
      弛
...
public:
        ...
        stride(stride), eps(epsilon)
    {
        ...
        if (expandRatio != 1) {
            ...
            slots.try_emplace("expand_bn_out", NodeSlot::internal, this);
            slots.try_emplace("expand_relu6_out", NodeSlot::internal, this);
        }
        slots.try_emplace("dw_out", NodeSlot::internal, this);
        slots.try_emplace("dw_bn_out", NodeSlot::internal, this);
        ...
        if (expandRatio != 1) {
            ...
            slots.try_emplace("expand_bn_gamma", NodeSlot::input, this);
            slots.try_emplace("expand_bn_beta", NodeSlot::input, this);
