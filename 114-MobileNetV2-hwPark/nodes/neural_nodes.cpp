...
// Global Vulkan device for neural network operations
Device netGlobalDevice = VulkanApp::get().device();

// Global descriptor pool for creating descriptor sets
...
// Request compute pipeline from cache or create new one if not exists
...
// Map of GEMM shader sources to their tile sizes for dispatch calculation
...
// Preload all shader pipelines into cache for faster access
void loadShaders()
{
...
// ConvolutionNode
/////////////////////////////////////////////////////////////////////////////////////////
// Initialize convolution node with im2col and GEMM pipelines
...
// Prepare convolution node by validating input shapes and allocating output tensors
...
// Execute convolution by running im2col followed by GEMM
...
// ReluNode
/////////////////////////////////////////////////////////////////////////////////////////
// Initialize ReLU node with compute pipeline
ReluNode::ReluNode()
{
    addSlot("in0", NodeSlot::input);
    addSlot("out0", NodeSlot::output);
...
// Prepare ReLU node by validating input and allocating output with same shape
...
// Execute ReLU activation function on input tensor
...
// MaxPoolingNode
/////////////////////////////////////////////////////////////////////////////////////////
// Initialize max pooling node with specified pool size
...
// Prepare max pooling node by calculating output shape based on pool size
...
// Execute max pooling operation on input tensor
...
// FlattenNode
/////////////////////////////////////////////////////////////////////////////////////////
// Initialize flatten node for reshaping tensor to 1D
...
// Prepare flatten node by reshaping input tensor to 1D
...
// Flatten node just shares tensor reference, no compute shader needed
...
// FullyConnectedNode
/////////////////////////////////////////////////////////////////////////////////////////
// Initialize fully connected node with GEMM and setZero pipelines
...
// Prepare fully connected node by validating input shapes and allocating output
...
// Execute fully connected layer by zeroing output then performing GEMM
