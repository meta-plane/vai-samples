...
Tests max pooling along dimension 0: [N, C] -> [C]
"""
...
def main():
    ...
    # MaxPool along dimension 0
    output, indices = torch.max(x, dim=0)
    ...
    # Save to file
    output_file = 'test/maxpool/reference.json'
    with open(output_file, 'w') as f:
        json.dump(data, f, indent=2)
    
    print(f"✓ Saved to {output_file}")
    print(f"  Input values: {N * C}")
